...
| `SQ_PKCS11_TEST_CONTAINER_MOUNTS` | colon-separated host paths to bind into rpm targets at the same location, for a module that needs more than SoftHSM2 does (`/opt/nfast`, say) |
